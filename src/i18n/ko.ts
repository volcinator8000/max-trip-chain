...
export const ko: Dict = {
  ...
  more_changes_cta: "환승 {n}회까지 허용",
  setup_france_only: "프랑스만 — 국가 추가",
  setup_hint: "철도망, 정기권, 유료 열차 변경",
  set_networks: "유럽 철도망",
  ...
  country_nl: "네덜란드",
  country_es: "스페인",
  net_offer_title: "{station}은(는) 비활성화된 철도망에 있습니다",
  net_offer_msg: "{country}({operator})를 켜면 이 역까지의 열차를 검색할 수 있습니다.",
  net_offer_action: "켜기",
  badge_reserve: "예약 필요",
