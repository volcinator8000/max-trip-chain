...
export const ja: Dict = {
  ...
  more_changes_cta: "乗り換え{n}回まで許可",
  setup_france_only: "フランスのみ — 国を追加",
  setup_hint: "鉄道網・定期券・有料列車を変更",
  ...
  country_nl: "オランダ",
  country_es: "スペイン",
  net_offer_title: "{station} は無効な鉄道網にあります",
  net_offer_msg: "{country}（{operator}）を有効にすると、この駅への列車を検索できます。",
