...
export const de: Dict = {
  ...
  more_changes_cta: "{n} Umstieg(e) erlauben",
  setup_france_only: "Nur Frankreich — Länder hinzufügen",
  setup_hint: "Netze, Abos und kostenpflichtige Züge ändern",
  ...
  country_es: "Spanien",
  net_offer_title: "{station} liegt in einem nicht aktivierten Netz",
  net_offer_msg: "Aktiviere {country} ({operator}), um Züge zu diesem Bahnhof zu suchen.",
  ...
  pass_route_from: "Von",
  pass_route_to: "Nach",
  pass_route_unset: "Keine Strecke angegeben – dieses Abo deckt bisher nichts ab.",
  pass_sncf_max_jeune: "MAX JEUNE",
  pass_sncf_max_senior: "MAX SENIOR (werktags)",
  pass_db_bahncard_100: "BahnCard 100",
  pass_db_bahncard_50: "BahnCard 50 (Rabatt)",
  pass_db_bahncard_25: "BahnCard 25 (Rabatt)",
  pass_db_deutschlandticket: "Deutschlandticket (nur Nahverkehr)",
  pass_sncb_go_unlimited: "SNCB Go Unlimited",
  pass_sncb_train_plus: "SNCB Train+ (Nebenzeit)",
  pass_ns_ov_jaarkaart: "NS OV-jaarkaart",
  pass_ns_traject_vrij: "NS Traject Vrij (eine Strecke)",
  pass_note_deutschlandticket: "Gilt nicht im ICE/IC – deckt also keinen Zug des hier geladenen Fernverkehrs ab.",
  pass_note_train_plus: "Rabatt im gesamten Netz, außerhalb der werktäglichen Hauptverkehrszeit.",
  badge_discount: "Rabatt",
  ...
  refine_working: "Suche nach besseren Verbindungen… ({round}/{total})",
