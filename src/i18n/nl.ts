...
export const nl: Dict = {
  ...
  more_changes_cta: "{n} overstap(pen) toestaan",
  setup_france_only: "Alleen Frankrijk — landen toevoegen",
  setup_hint: "Netwerken, abonnementen en betaalde treinen wijzigen",
