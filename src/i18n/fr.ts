export const fr = {
  ...
  more_changes_cta: "Autoriser {n} correspondance(s)",
  setup_france_only: "France seulement — ajouter des pays",
  setup_hint: "Modifier les réseaux, abonnements et trains payants",
  ...
  country_nl: "Pays-Bas",
  country_es: "Espagne",
  net_offer_title: "{station} est dans un réseau désactivé",
  net_offer_msg: "Activez {country} ({operator}) pour chercher des trains vers cette gare.",
