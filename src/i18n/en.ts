...
export const en: Dict = {
  ...
  more_changes_cta: "Allow {n} change(s)",
  setup_france_only: "France only — add countries",
  setup_hint: "Change networks, subscriptions and paid trains",
  ...
  country_es: "Spain",
  net_offer_title: "{station} is on a network you haven't enabled",
  net_offer_msg: "Turn on {country} ({operator}) to search trains to this station.",
  ...
  pass_route_from: "From",
  pass_route_to: "To",
  pass_route_unset: "No route named — this subscription covers nothing yet.",
  pass_sncf_max_jeune: "MAX JEUNE",
  pass_sncf_max_senior: "MAX SENIOR (weekdays)",
  pass_db_bahncard_100: "BahnCard 100",
  pass_db_bahncard_50: "BahnCard 50 (discount)",
  pass_db_bahncard_25: "BahnCard 25 (discount)",
  pass_db_deutschlandticket: "Deutschlandticket (regional only)",
  pass_sncb_go_unlimited: "SNCB Go Unlimited",
  pass_sncb_train_plus: "SNCB Train+ (off-peak)",
  pass_ns_ov_jaarkaart: "NS OV-jaarkaart",
  pass_ns_traject_vrij: "NS Traject Vrij (one route)",
  pass_note_deutschlandticket: "Not valid on ICE/IC — so it covers none of the long-distance network loaded here.",
  pass_note_train_plus: "A reduction across the network, outside the weekday rush hours.",
