...
export const zh: Dict = {
  ...
  more_changes_cta: "允许换乘 {n} 次",
  setup_france_only: "仅法国 — 添加国家",
  setup_hint: "更改铁路网、通票与付费列车",
  set_networks: "欧洲铁路网",
  ...
  country_nl: "荷兰",
  country_es: "西班牙",
  net_offer_title: "{station} 属于未启用的铁路网",
  net_offer_msg: "启用{country}（{operator}）即可搜索前往该站的列车。",
  net_offer_action: "启用",
  badge_reserve: "需订座",
